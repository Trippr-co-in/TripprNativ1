    ...
    <ScrollView style={styles.container} contentContainerStyle={{flexGrow: 1}}>
      ...
      <View style={styles.taxitab}>
        <TouchableOpacity
          ...
          {buttonStates2[0] ? (
            <Image
              source={require('../assets/airport-white-icon.png')}
              style={{width: 25, height: 25, resizeMode: 'contain'}}
            />
          ) : (
            <Image
              source={require('../assets/airport-black-icon.png')}
              style={{width: 25, height: 25, resizeMode: 'contain'}}
            />
          )}
        ...
        <TouchableOpacity
          ...
          {buttonStates2[1] ? (
            <Image
              source={require('../assets/local-white-icon.png')}
              style={{width: 25, height: 25, resizeMode: 'contain'}}
            />
          ) : (
            <Image
              source={require('../assets/local-black-icon.png')}
              style={{width: 25, height: 25, resizeMode: 'contain'}}
            />
          )}
          <Text
        ...
        <TouchableOpacity
          ...
          {buttonStates2[2] ? (
            <Image
              source={require('../assets/outstation-white-icon.png')}
              style={{width: 25, height: 25, resizeMode: 'contain'}}
            />
          ) : (
            <Image
              source={require('../assets/outstation-black-icon.png')}
              style={{width: 25, height: 25, resizeMode: 'contain'}}
            />
          )}
          <Text
      ...
      {/* <View style={styles.faqs_container}>
        <View
          ...
          <Image
            ...
            source={require('../assets/faqs-title-image.png')}
          />
